...
--
--  شغّله **بعد `install.sql`** — ولا يحتاج غيرَه. آمنٌ عند التكرار.
--
--  **ولا يُلصق في محرّر SQL إلّا هذا الملفّ.** ونظيرُه في
--  `supabase/tests/phone_verify.test.mjs` ملفُّ **اختبارٍ** يعمل بـNode لا
--  بـPostgres — ومن لصقه في المحرّر رأى `syntax error` عند `import`. وقد
--  وقع.
-- ============================================================================
--
