...
/// (‎٤٫٦٨:١‎) و`goldOnAccent` للحبر على النبيذيّ.
///
...
class AppColors {
  ...
  /// ذهبٌ على الفاتح (‎٤٫٦٨:١‎)، وذهبٌ على النبيذيّ.
  static const gold = Color(0xFF9A6B18);

  /// **ويُقاس على طرفَي التدرّج لا على وسطه.**
  ///
  /// كان `#D9B45C` وقِيس على `accent` وحده فأعطى ‎٥٫٤٥:١‎. لكنّ البطاقة
  /// الكبيرة تدرّجٌ من `accentLift` إلى `accentDeep`، وعلى الطرف الفاتح كان
  /// يعطي **‎٤٫٠٩:١‎** — تحت العتبة. أي أنّ سطر «بقي ١٣١ يوماً» في «خطة
  /// العرس» كان دون العتبة منذ كُتب، ولم يظهر ذلك لأن القياس وقع على اللون
  /// الخطأ. كشفه اختبارٌ سقط حين وُسّع القياس إلى الطرفين.
  ///
  /// وهذا يعطي ‎٤٫٨١:١‎ على الفاتح و‎٨٫٢٨:١‎ على الغامق، وحبرٌ نبيذيٌّ عليه
  /// ‎٨٫٢٨:١‎ — وهو زرُّ «ابدأ رحلتك» وزرُّ الدفع في «حجوزاتي».
  static const goldOnAccent = Color(0xFFE6C473);
