...
///
/// **ومتغيّرةٌ لا ثابتة**: لشاشة الدفع حالان — أرقامٌ مضبوطةٌ فيُعرض نموذجُ
/// الإبلاغ، ولا أرقامَ فيُقال الحالُ ويُوجَّه إلى الدعم. والثانيةُ هي التي
/// يراها صاحبُ المنصّة على قاعدته، فلا تُقاس ولا تُصوَّر إن لم تُبدَّل.
var demoPaymentSettings = const PaymentSettings(
  jawali: '770 000 000',
  kuraimi: '1234567890',
...
///
/// **وأربعُ خاناتٍ كالواقع.** كان ستّاً، والمُرسِلُ يُرسل أربعاً — فلمّا
/// صار في الحقل حدٌّ بأربعٍ صار الاختبارُ يكتب ستّاً فتُقصّ إلى أربع
/// فيُردّ الرمز. **وضعُ العرض يقلّد الواقعَ أو لا يُقاس به شيء.**
const demoOtpCode = '4180';
