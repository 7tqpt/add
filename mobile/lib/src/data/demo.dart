...
/// **ولا رابطَ في النسخة التجريبيّة.** حزمةٌ بلا أسرارٍ تعمل على بياناتٍ
/// مصنوعة، ورابطُ تنزيلٍ فيها يدعو الناسَ إلى نسخةٍ لا تتّصل بقاعدةٍ أصلاً.
/// فيُخفى زرُّ مشاركة التطبيق فيها، ويبقى زرُّ مشاركة الخدمة عاملاً.
const demoShareUrl = '';
