...
class Api {
  ...
  ///
  /// **ولا بديلَ يُكتب هنا عن الشاشة.** حين يسكت الخادمُ عن السبب، الشاشةُ
  /// هي التي تكتب النصَّ البديل — فهي تعرف ما كان يفعله صاحبُه.
  ///
  /// (وكان هنا سطرٌ يقول إنّ هذا الملفَّ لا ينادي `tr` في موضعٍ واحدٍ منه.
  /// **وصار كاذباً**: رسائلُ «قاعدتك لم تُحدَّث بعد: شغّل هذا الملفّ» تمرّ
  /// بـ`tr` منذ دمجة الغلاف. وهي رسائلُ عطبٍ في الإعداد تُعرض كما هي بلا
  /// شاشةٍ تعرف سياقَها، فموضعُها هنا. وتعليقٌ لا يطابق ما تحته أسوأُ من
  /// لا تعليق: يُقرأ قاعدةً فيُبنى عليها.)
  ///
