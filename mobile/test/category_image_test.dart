...
void main() {
  ...
  testWidgets('**والصورةُ داخل دائرةِ الأيقونة نفسِها — ٣٢ داخلَ ٣٤**',
      (tester) async {
    ...
    // **اثنان وثلاثون داخلَ قرصٍ أربعةٍ وثلاثين.** صغُر القرصُ من ٣٦ إلى ٣٤
    // حين ابيضّت أرضيّةُ البطاقة، وصارت له حافّةٌ بلون قسمه عرضُها واحد —
    // والحافّةُ تُزيح ما بداخلها، فيبقى للصورة اثنان وثلاثون وتُحيط بها
    // الحلقةُ المصبوغة. قِستُه ولم أفترضه: ظننتُها ٣٤ فخرجت ٣٢.
    expect(tester.getSize(glyph), const Size(32, 32));
  });
}
