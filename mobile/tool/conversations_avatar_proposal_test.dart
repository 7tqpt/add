...
//
// كان راسمَ مقترحٍ يرسم صفوفاً تشبه صفوفَ القائمة، إذ كان `_Row` خاصّاً بها
// ولا مدخلَ لصورته. فلمّا نُفِّذ **قُلب ولم يُحذف**: صار يصوّر
// `ConversationsScreen` المشحونةَ نفسَها.
//
