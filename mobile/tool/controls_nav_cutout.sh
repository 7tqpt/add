...
# ── ح) وتقع الحفرةُ على الركن المستدير ────────────────────────────────────
#
# **وهذا هو العطبُ الذي شُكي منه بعينه.** بلا حبسٍ عن الركنين تقع حفرةُ
# التبويب الأوّل والأخير على ركنٍ مستدير، فيأكل القطعُ المشترَك نصفَها: لا
# حفرةَ تتشكّل ويتدلّى القرصُ خارجَ الشريط. وكان يمرّ صامتاً لأنّ الحزمةَ
# تسأل «أمقصوصٌ تحت القرص؟» — وهو مقصوصٌ هناك أيضاً بل أكثرُ ممّا يجب.
run "(ح) الحفرةُ تقع على الركن" \
  sub "$K" \
